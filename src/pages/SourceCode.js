      ...
      <div className="flex min-h-screen bg-gray-900 flex-col md:flex-row text-white font-sans justify-center">
        <div className="flex-1 p-8 max-w-3xl">
          <h1 className="text-4xl font-bold mb-6">
            Diwali Source Code Sale at 199rs Only
          </h1>
          <p className="mb-4">
            Happy Diwali 🎉 Are you looking for high-quality, ready-to-use
            website source code? Look no further! Our collection of more than
            10+ projects & websites has everything you need to get started on
            your next project.
          </p>
          <p className="mb-4">
            With responsive design, user-friendly navigation, and a range of
            powerful features and tools, these websites are sure to impress. And
            the best part? You can get access to the entire collection for just
            ₹199 wow.
          </p>
          <p className="mb-4">
            But that's not all. Not only do you get the source code for these
            amazing websites, all the videos are already uploaded on my youtube
            channel, so that you can learn and actually understand it. If you
            have any questions or need help getting started, just let us know
            and we'll be happy to assist.
          </p>
          <p className="mb-4">
            So why wait? Get the source code for these top-quality projects &
            websites now and take the first step towards creating something
            amazing. Order now and start building today!
          </p>
        </div>
        <div className="flex-1 p-8 bg-gray-800 max-w-md">
          <h2 className="text-2xl font-bold mb-4">
            Your Path to Full-Stack Success with Thapa Technical
          </h2>
      ...
      <div className="bg-gray-900 text-white p-8 ">
          ...
          <div className="flex flex-col md:flex-row md:justify-between items-center">
            <div className="w-full md:w-[70%]">
              <h1 className="text-xl font-bold">
                India's Best Hosting and Domain
              </h1>
              <p className="mt-2">
                At Hostinger, we believe that hosting must be for everyone.
                That's why we provide the best services at the most affordable
                price. Get started now with the given link to get up to{" "}
                <span className="font-bold">85% discount</span>{" "}
                <span role="img" aria-label="pointer">
                  👉
                </span>
              </p>
              <p className="mt-2">
                Don't forget to use <span className="font-bold">THAPA7</span>{" "}
                promo code to get an extra{" "}
                <span className="font-bold">10% discount</span> on existing
                discount.
              </p>
            </div>
            <button className="bg-[#6f3d2e] hover:bg-[#6f3d2e] px-4 py-2 rounded-md">
              Checkout Now
            </button>
          </div>
        </header>
        ...
        <section className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold mb-6">
            Get Awesome Project Codes for Free
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {projectCards.map((card) => (
              <div
                key={card.title}
                className="bg-gray-800 p-4 rounded-lg flex flex-col justify-between hover:border-[1px] border-orange-500"
              >
                ...
                <div className="p-4 ">
                  ...
                  <button className="mt-4 w-full px-4 py-2 rounded-md bg-green-600 hover:bg-green-700">
                    Download
                  </button>
                </div>
              </div>
